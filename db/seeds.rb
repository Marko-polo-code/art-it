...
body_worlds = Collection.new(title: "Body Worlds", description: "THE medical exposition, causing controversy since three decade.", price: 4000, user: User.all.sample, address: ADDRESSES.sample)
body_worlds.save!
p body_worlds
wookie_art = Collection.new(title: "Wookie Art", description: "Wonderful, graceful artisan crafts exquisitely chewed to perfection by our furry friends", price: 350, user: User.all.sample, address: ADDRESSES.sample)
wookie_art.save!
p wookie_art
abc_collection = Collection.new(title: "ABC Collection", description: "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. ", price: 200, user: User.all.sample, address: ADDRESSES.sample )
abc_collection.save!

antique_weapons = Collection.new(title: "Antique Weapons and Armours", description: "The collection is the oldest collection in the Deutsches Historisches Museum and closely connected with the history of the Zeughaus (“Armoury”). It comprises around 30,000 objects – from the Roman gladius (sword) to the Russian assault rifle Kalashnikov, from the tiny lock component of a hunting musket to the heaviest piece of artillery.", price: 1200, user: User.all.sample, address: ADDRESSES.sample)
antique_weapons.save!

doorknobs = Collection.new(title: "Finest Doorknobs - By Knobby Knob", description: "doorknob, doorknob, doorknob, doorknob, doorknob, doorknob", price: 400, user: User.all.sample, address: ADDRESSES.sample)
doorknobs.save!

rings = Collection.new(title: "Rings of Middle Earth", description: "Sauron, elven, human and dwarfish rings on display – DISCLAIMER: monsters might turn up and eat all attendees", price: 40000, user: User.all.sample, address: ADDRESSES.sample)
rings.save!

sigmar_polke = Collection.new(title: "Sigmar Polke - Modern Art", description: "The permanent exhibition documents the history of Berlin's police force on a space of roughly 500 square metres. Among the items on display are historical uniforms, weapons and equipment. A number of firearms and tools used in actual criminal cases are also on display. I", price: 200, user: User.all.sample, address: ADDRESSES.sample)
sigmar_polke.save!

hearth_stone = Collection.new(title: "Hearth Stone Collection", description: "Thousands of magical cards to place around your establishment. DISCLAIMER: Usually attracts Victor's", price: 500, user: User.all.sample, address: ADDRESSES.sample)
hearth_stone.save!

michelangelo_collection = Collection.new(title: "Michelangelo's Sculptures", description: "Wonderful, graceful artisan crafts exquisitely chewed to perfection by our furry friends", price: 30000000, user: User.all.sample, address: ADDRESSES.sample)
